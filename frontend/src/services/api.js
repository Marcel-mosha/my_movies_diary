...
// Use relative path to work with Docker Nginx proxy
...
export const moviesAPI = {
  ...
  searchTMDB: (title) => api.get("/movies/search_tmdb/", { params: { title } }),

  fetchTMDBDetails: (movieId) =>
    api.get("/movies/fetch_tmdb_details/", { params: { id: movieId } }),
};
